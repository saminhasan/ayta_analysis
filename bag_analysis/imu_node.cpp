...
void loop(ros::NodeHandle pn, ros::NodeHandle n) {
    ...
    geometry_msgs::Vector3Stamped imu_ypr_msg;
    imu_ypr_msg.header.stamp = now;
    imu_ypr_msg.header.frame_id = frame_id;
...
int main(int argc, char **argv){
    ...
    imu_ypr_pub = n.advertise<geometry_msgs::Vector3Stamped>("imu/euler", 10);
